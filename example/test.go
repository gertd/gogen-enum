// Package example -- generated by gogen-enum from source: [./test.yaml]
//
// !! DO NOT EDIT !!
//
package example
...
var addressKindName = map[string]AddressKind{
	"Unknown":   AddressKindUnknown,
	"Home":      AddressKindHome,
	"Office":    AddressKindOffice,
	"PostalBox": AddressKindPostalBox,
}
